package org.bpmnwithactiviti.chapter6.transaction;
...
@ContextConfiguration("classpath:chapter6/spring-transaction-context.xml")
public class TransactionTest extends AbstractTest {
  ...
  public ActivitiRule activitiSpringRule;
	...
	@Test
	@Deployment(resources={"chapter6/transaction/transaction.test.bpmn20.xml"})
