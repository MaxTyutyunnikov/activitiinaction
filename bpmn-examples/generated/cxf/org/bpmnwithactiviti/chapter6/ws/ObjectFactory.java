 ...
 * generated in the org.bpmnwithactiviti.chapter6.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _FindCustomerResponse_QNAME = new QName("http://ws.chapter6.bpmnwithactiviti.org/", "findCustomerResponse");
    private final static QName _StoreSalesOpportunity_QNAME = new QName("http://ws.chapter6.bpmnwithactiviti.org/", "storeSalesOpportunity");
    private final static QName _StoreSalesOpportunityResponse_QNAME = new QName("http://ws.chapter6.bpmnwithactiviti.org/", "storeSalesOpportunityResponse");
    private final static QName _FindCustomerByIdResponse_QNAME = new QName("http://ws.chapter6.bpmnwithactiviti.org/", "findCustomerByIdResponse");
    private final static QName _FindCustomerById_QNAME = new QName("http://ws.chapter6.bpmnwithactiviti.org/", "findCustomerById");
    private final static QName _FindCustomer_QNAME = new QName("http://ws.chapter6.bpmnwithactiviti.org/", "findCustomer");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.bpmnwithactiviti.chapter6.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.chapter6.bpmnwithactiviti.org/", name = "findCustomerResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.chapter6.bpmnwithactiviti.org/", name = "storeSalesOpportunity")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.chapter6.bpmnwithactiviti.org/", name = "storeSalesOpportunityResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.chapter6.bpmnwithactiviti.org/", name = "findCustomerByIdResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.chapter6.bpmnwithactiviti.org/", name = "findCustomerById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.chapter6.bpmnwithactiviti.org/", name = "findCustomer")
